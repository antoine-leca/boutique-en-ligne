...
<head>
    ...
    <link rel="stylesheet" href="/Demetech/public/css/home.css">
    ...
    <section class="hero nzxt-hero">
        <div class="hero-content">
            ...
            <div class="hero-image">
                <img src="/Demetech/public/assets/tour.png" alt="NZXT H6 Flow">
            </div>
        </div>
    </section>
...
<section class="featured-grid">
    ...
    <div class="featured-item ps5">
        ...
        <div class="featured-image">
            <img src="/Demetech/public/assets/PlayStation.png" alt="PlayStation 5">
        </div>
    </div>
    ...
    <div class="featured-item macbook">
        ...
        <div class="featured-image">
            <img src="/Demetech/public/assets/MacBook.png" alt="MacBook Air">
        </div>
    </div>
    ...
    <div class="bottom-left-container">
        ...
        <div class="featured-item iphone">
            ...
            <div class="featured-image">
                <img src="/Demetech/public/assets/Iphone.png" alt="iPhone 14 Pro">
            </div>
        </div>
        ...
        <div class="featured-item corsair">
            ...
            <div class="featured-image">
                <img src="/Demetech/public/assets/clavier.png" alt="Clavier Corsair">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="category-grid">
            ...
            <a href="#" class="category-item">
                <div class="category-icon d-icon">
                    <img src="/Demetech/public/assets/Petit_logo.png" alt="D Icon">
                </div>
                <p>Goodies</p>
            </a>
        </div>
