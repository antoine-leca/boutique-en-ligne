    ...
    if (isset($_POST["form_type"]) && $_POST["form_type"] === "connexion") {
        ...
        if (!empty($_POST["mail"]) && !empty($_POST["password"])) {
            ...
            if ($userData && password_verify($password, $userData["password"])) {
                ...
                $_SESSION["user"] = [
                    "id_user" => htmlspecialchars($userData["id"]),
                    "prenom" => htmlspecialchars($userData["firstname"]),
                    "nom" => htmlspecialchars($userData["lastname"]),
...
<div id="modalCR" class="modal w-[250px] fixed top-16 right-48 hidden bg-white border-2 border-gray-300 rounded-lg shadow-lg z-50">
    <div class="modal-content h-full flex flex-col m-1">
